@extends('panel.layout.master' , ['title' => 'الفئات'])
    ...
    <div class="kt-subheader  kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">الفئات</h3>
            </div>
        </div>
    </div>
@endsection
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ route('panel.catagories.create')}}"
...
@push('js')
    ...
    <script>
        ...
        window.data_url = '{{ route('panel.catagories.datatable') }}';
        ...
        window.columns = [
...

            {
                ...
                width: 210,
                template: function (data) {
                    var url = "{{ url('panel/catagories/') }}/" + data.id + "/edit";
                    var deleteUrl = "{{ url('panel/catagories/') }}/" + data.id;
