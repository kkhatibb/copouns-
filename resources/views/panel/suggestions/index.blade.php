@extends('panel.layout.master' , ['title' => 'الإقتراحات'])
    ...
    <div class="kt-subheader  kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">الإقتراحات</h3>
            </div>
        </div>
    </div>
@endsection
...
@push('js')
    ...
    <script>
        window.data_url = '{{url('panel/suggestions/datatable')}}';
        ...
        window.columns = [
            ...
            },
            {
                ...
                autoHide: false,
                template: function (data) {
                    var editUrl = "{{ url('panel/suggestions/') }}/" + data.id + "/show";
                    var deleteUrl = "{{ url('panel/suggestions/') }}/" + data.id;
                    return `
